...
from platefunctions.plateFinder import PlateFinder
from platefunctions.predicter import Predicter
from platefunctions.plateDisplay import PlateDisplay
import os
...
def predictImages(modelArg, image_displayArg, pred_stagesArg):
  # Number of different classes 
  num_classesArg = 37
  labelsArg = os.path.join(os.path.dirname(__file__), "classes/classes.pbtxt")
  imagePathArg = os.path.join(os.path.dirname(__file__), "image")
  min_confidenceArg = 0.5  
...
if __name__ == '__main__':
  ...
  results = predictImages(args["model"], args["image_display"], args["pred_stages"])
  print('results')